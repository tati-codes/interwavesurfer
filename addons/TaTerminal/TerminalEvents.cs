...
namespace Taterminal {
  #region Logging
    public class Text : Args {
      ...
      public Text(string t) {
        text = t;
        this.tag = Taterminal.tag.info;
      }
      public static Text error(string t) => new Text(t) { tag = Taterminal.tag.error};
      public static Text warn(string t) => new Text(t) { tag = Taterminal.tag.warning};
      public static Text evnt(string t) => new Text(t) { tag = Taterminal.tag.evnt};
      public static Text count(string t) => new Text(t) { tag = Taterminal.tag.count};
  ...
  #region Base Bus Classes
    ...
    public abstract class Args {
        ...
        public virtual tag tag {get; set;} = Taterminal.tag.evnt;
    ...
    public class DbgString : Args {
      ...
      public static DbgString import(string msg) {
          ...
          return new DbgString() {
              ...
              tag = Taterminal.tag.fromString(tag)
          };
      }
    }
